...
#plotbt.custom.report.part2(models$vix.mom, trade.summary = T)
#plotbt.custom.report.part3(models$vix.mom, trade.summary = T) #trade table, not working?